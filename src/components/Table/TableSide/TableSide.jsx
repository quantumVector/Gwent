...
const TableSide = ({ className, side, ...props }) => {
  return (
    <div className={classes[className]}>
      <Field side={side} typeUnits='Melee' typeComponent='Power' {...props} />
      <Field side={side} typeUnits='Ranged' typeComponent='Power' {...props} />
      <Field side={side} typeUnits='Siege' typeComponent='Power' {...props} />
